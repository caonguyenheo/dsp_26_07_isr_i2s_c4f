...
/*
 *
 *  EVM5515_I2CGPIO_configLine( line, dir )
 *
 *      Uint16 line        <-  I2C GPIO line (defined in EVM5515_i2cgpio.h)
 *      Uint16 dir         <-  I2C GPIO direction (defined in EVM5515_i2cgpio.h)
 * 
 *  Description
...
Int16 EVM5515_I2CGPIO_configLine(  Uint16 line, Uint16 dir )
{
    ...
    EVM5515_I2CGPIO_read(  regnum, &regval );
    ...
    EVM5515_I2CGPIO_write( regnum, regval );
...
/*
 *
 *  EVM5515_I2CGPIO_readLine( line )
 *
 *      Uint16 line        <-  I2C GPIO line (defined in EVM5515_i2cgpio.h)
 * 
 *      Returns:           ->  I2C GPIO STATE (defined in EVM5515_i2cgpio.h)
 * 
 *  Description
...
/*
 *
 *  EVM5515_I2CGPIO_writeLine(  line, val )
 *
 *      Uint16 line        <-  I2C GPIO line  (defined in EVM5515_i2cgpio.h)
 *      Uint16 val         <-  I2C GPIO state (defined in EVM5515_i2cgpio.h)
 * 
 *  Description
 ...
 *
 */
Int16 EVM5515_I2CGPIO_read(  Uint16 regnum, Uint16* regval )
{
    Int16  retcode = 0;
    Uint8 cmd[2];
    ...
    retcode |= EVM5515_I2C_write( I2CGPIO_I2C_ADDR, cmd, 1 );
    
    /* Return register value */
    retcode |= EVM5515_I2C_read( I2CGPIO_I2C_ADDR, cmd, 1 );
    *regval = cmd[0];
    EVM5515_waitusec( 50 );
 ...
 *
 */
Int16 EVM5515_I2CGPIO_write( Uint16 regnum, Uint16 regval )
{
    Uint8 cmd[2];
    ...
    return EVM5515_I2C_write( I2CGPIO_I2C_ADDR, cmd, 2 );
}
